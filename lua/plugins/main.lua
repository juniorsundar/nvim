return {
    ...
    },
    {
        ...
        cmd = "Trouble",
        keys = {
            { "<leader>LWd", "<cmd>Trouble diagnostics toggle<cr>",                                       desc = "Diagnostics (Trouble)" },
            { "<leader>LDd", "<cmd>Trouble diagnostics toggle filter.buf=0<cr>",                          desc = "Buffer Diagnostics (Trouble)" },
            { "<leader>LL",  "<cmd>Trouble lsp toggle focus=true win.type=split win.position=bottom<cr>", desc = "LSP Definitions / references / ... (Trouble)", },
